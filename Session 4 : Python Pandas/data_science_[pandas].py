...
Original file is located at
    https://colab.research.google.com/drive/1ouRSsu-Os9I7k-kl2bPtQTsjWtArLNCO
...
temp_list = ['ggplot', 'bmh', 'dark_background', 'fivethirtyeight']

import matplotlib.pyplot as plt
plt.style.use(temp_list[1])
